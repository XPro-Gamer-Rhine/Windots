...
Set-PSReadLineKeyHandler -Key Ctrl+Shift+b `
                         ...
                         -ScriptBlock {
    [Microsoft.PowerShell.PSConsoleReadLine]::RevertLine()
    [Microsoft.PowerShell.PSConsoleReadLine]::Insert("yarn run build")
...
Set-PSReadLineKeyHandler -Key Alt+r `
                         ...
                         -ScriptBlock {
    [Microsoft.PowerShell.PSConsoleReadLine]::RevertLine()
    [Microsoft.PowerShell.PSConsoleReadLine]::Insert("yarn dev")
    [Microsoft.PowerShell.PSConsoleReadLine]::AcceptLine()
}
...
New-Alias -Name gpo -Value Get-GitPullOrigin -Force -Option AllScope
...
New-Alias -Name gr -Value Get-GitRebase -Force -Option AllScope
...
function Get-GitFetchAll { & git fetch --all --prune $args }
New-Alias -Name gfa -Value Get-GitFetchAll -Force -Option AllScope

function Get-GitPushOriginHead { & git push origin head $args }
New-Alias -Name gph -Value Get-GitPushOriginHead -Force -Option AllScope

function Set-NvmDefault { & nvm alias default $args }
New-Alias -Name dn -Value Set-NvmDefault -Force -Option AllScope

function Use-NvmDefault { & nvm use default $args }
New-Alias -Name udn -Value Use-NvmDefault -Force -Option AllScope

function Start-YarnDev { & yarn dev $args }
New-Alias -Name yd -Value Start-YarnDev -Force -Option AllScope

function Start-YarnStart { & yarn start $args }
New-Alias -Name ys -Value Start-YarnStart -Force -Option AllScope

function Open-VSCode { & code . $args }
New-Alias -Name c -Value Open-VSCode -Force -Option AllScope

function Invoke-Yarn { & yarn $args }
New-Alias -Name y -Value Invoke-Yarn -Force -Option AllScope
